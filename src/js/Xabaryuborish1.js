...
import s from '../css/Xabaryuborish1.module.css';
        ...
        return (
            <div className={s.hammasi1}>
              <div className={s.sharw} ></div> 
                 <h5 id='xabar' style={{marginTop:'100px',marginBottom:'30px'}} className={s.title}>ЗАПИШИТЕСЬ НА <span>БЕСПЛАТНЫЙ МАСТЕР-КЛАСС</span></h5>
                 <Container fluid>
         <Row className={s.row1}>

         
             <Col lg={12} md={12} sm={12} xs={12} className={s.uchtalik1}>
                 <div style={{display:'flex'}} className={s.as}>
                 <Form style={{width:'100%'}}>
        <img className={s.robit} src={robot} alt=" "/>
